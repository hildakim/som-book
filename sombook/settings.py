"""
Django settings for sombook project.
...
ROOT_URLCONF = 'sombook.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['sombook/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'sombook.wsgi.application'
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, 'sombook', 'static'),
